...
pts_dir <- "C:/Users/jlinsky/Documents/MagnoliaCoordinator/Data/SpeciesData/Occurrences/inputs/compiled_occurrence"
ex_pts_dir <- "C:/Users/jlinsky/Documents/MagnoliaCoordinator/Data/SpeciesData"
	## for polygon data (ecoregions, states, countries)
poly_dir <- "C:/Users/jlinsky/Documents/MagnoliaCoordinator/Data/SpeciesData/polygons"
	## for outputs
output_dir <- "C:/Users/jlinsky/Documents/MagnoliaCoordinator/Data/SpeciesData/Occurrences/outputs"
...
state_bound <- readOGR(file.path(poly_dir,"gadm36_USA_shp/gadm36_USA_1.shp"))
...
state_centers$label <- state_bound.wgs@data$NAME_1
...
exsitu <- read.csv(file.path(ex_pts_dir,paste0(target_sp[sp],
	"_exsitu_POSTGEOLOCATE.csv")),na.strings=c("","NA"),stringsAsFactors = F)
str(exsitu)
...
map <- leaflet(options = leafletOptions(maxZoom = 9)) %>%
  ...
  ##	not sure yet how to have both on the map
  addPolygons(
    data = state_bound.wgs, label = ~NAME_1, fillColor = "transparent",
